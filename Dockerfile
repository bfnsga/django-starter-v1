...
CMD python manage.py makemigrations && python manage.py migrate && python manage.py collectstatic --noinput && gunicorn main.wsgi --worker-tmp-dir /dev/shm --bind 0.0.0.0:8000 --workers 2